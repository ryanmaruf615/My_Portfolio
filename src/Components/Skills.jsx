...
import express from "../assets/skill/ex.png";
import mongodb from "../assets/skill/mongo.png";
import python from "../assets/skill/python.png";
import dotnet from "../assets/skill/net.png";
import postgres from "../assets/skill/postgress.png";
...
import github from "../assets/skill/git.png"; // Using same as git since there's no separate github file
